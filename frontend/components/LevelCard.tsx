    ...
    return (
      <div className={`glass-card p-6 ${className}`}>
        <div className="animate-pulse">
          ...
          <div className="h-16 bg-[var(--glass-bg)] rounded"></div>
        </div>
      </div>
    );
  }
    ...
    <div className={`glass-card p-6 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-[var(--text-primary)]">等级</h3>
        </div>
      ...
      <div className="text-center mb-6">
        ...
        <div className="text-[var(--text-secondary)] font-medium">{data.level_title}</div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[var(--border)]">
        <div className="text-center">
          ...
          <div className="text-xs text-[var(--text-tertiary)]">连续记录</div>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-1">
          ...
          <div className="text-xs text-[var(--text-tertiary)]">最长连续</div>
        </div>
      </div>
    </div>
  );
