  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div>
        ...
        <p className="text-sm text-white/40 mt-1">追踪目标，解锁徽章</p>
      </div>
      ...
      <section className="animate-fade-in delay-2">
        <div className="mb-3">
          <h2 className="text-lg font-semibold text-white/80">活跃挑战</h2>
          <p className="text-xs text-white/40 mt-0.5">完成挑战获得经验值</p>
        </div>
      ...
      <section className="animate-fade-in delay-3 pt-4 border-t border-white/[0.06]">
        <div className="mb-3">
          <h2 className="text-lg font-semibold text-white/80">个人目标</h2>
          <p className="text-xs text-white/40 mt-0.5">设定并追踪你的目标</p>
        </div>
        <Goals />
      </section>
      ...
      <section className="animate-fade-in delay-4 pt-4 border-t border-white/[0.06]">
        <div className="mb-3">
          <h2 className="text-lg font-semibold text-white/80">徽章收藏</h2>
          <p className="text-xs text-white/40 mt-0.5">你获得的所有成就</p>
        </div>
