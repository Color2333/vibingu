  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-40 p-2 rounded-xl bg-[var(--glass-bg)] backdrop-blur-xl border border-[var(--border)] 
                   text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] transition-all md:hidden"
        aria-label="打开菜单"
      >
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-[var(--border)]">
          ...
          <button
            onClick={() => setIsMobileOpen(false)}
            className="p-1.5 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--glass-bg)] transition-all md:hidden"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            return (
              <button
                ...
                className={`
                  ...
                  group relative
                  ${isActive 
                    ? 'bg-gradient-to-r from-indigo-500/20 to-purple-500/20 text-[var(--text-primary)] border border-indigo-500/30' 
              ...
              >
                ...
                {isExpanded && (
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-[10px] text-[var(--text-tertiary)]">{item.description}</div>
                  </div>
                )}
                ...
                {!isExpanded && (
                  <div className="
                    ...
                    bg-[var(--bg-card)] rounded-lg border border-[var(--border)] shadow-lg
        ...
        <div className="p-3 border-t border-[var(--border)] space-y-2">
          ...
          <button
            ...
            className={`
              ...
              text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--glass-bg)] transition-all
          ...
          >
            ...
            {isExpanded && <span className="text-sm">{resolvedTheme === 'dark' ? '浅色模式' : '深色模式'}</span>}
          </button>
